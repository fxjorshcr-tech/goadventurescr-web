      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-green-800 mt-8 pt-8 text-center text-gray-400">
          ...
          <a
            ...
            className="group mt-4 inline-flex items-center justify-center gap-3 text-gray-300 hover:text-orange-400 transition-all duration-300"
          >
            ...
            <Image
              ...
              width={200}
              height={60}
              className="h-14 w-auto invert opacity-70 group-hover:opacity-100 transition-all duration-300"
            />
          </a>
        </div>
      </div>
