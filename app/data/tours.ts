...
A traditional lunch with local flavors completes this perfect combination of nature and culture.`,
  ...
  {
    id: "combo-perezosos-chocolate",
    title: "Sloth Sanctuary & Chocolate Tour",
    description: "Meet adorable sloths in their natural habitat, hike to a beautiful waterfall, and enjoy a delicious coffee and chocolate tasting experience.",
    longDescription: `This is the ultimate feel-good combo experience — combining encounters with Costa Rica's most beloved animal, the sloth, with a waterfall hike and an indulgent journey through the world of sustainable coffee and chocolate production.

SLOTH SANCTUARY
Begin your day at a wildlife sanctuary dedicated to the conservation and rehabilitation of sloths — Costa Rica's most iconic and endearing creatures. Both two-toed and three-toed sloths call this sanctuary home, and you will have the incredible opportunity to observe them up close in a natural, respectful setting.

Your expert naturalist guide will share fascinating facts about sloth biology and behavior — did you know that sloths can hold their breath underwater for up to 40 minutes, or that they only descend from their trees once a week? Learn about the conservation challenges facing these gentle creatures, from habitat loss to power line dangers, and how the sanctuary works to protect and rehabilitate injured sloths for release back into the wild.

The sanctuary is also home to other Costa Rican wildlife including toucans, butterflies, and other tropical species, making it a nature lover's paradise.

WATERFALL HIKE
Next, embark on a scenic hike through tropical forest to a stunning waterfall. The trail winds through lush vegetation teeming with wildlife, and your guide will point out interesting plants, birds, and insects along the way. At the waterfall, take in the majestic sight and sound of water cascading into a natural pool — a perfect moment of tranquility in the heart of the rainforest.

COFFEE & CHOCOLATE TASTING TOUR
Complete your experience with a visit to a sustainable farm where coffee and cacao are grown side by side. Learn about the journey from cacao bean to chocolate bar in a hands-on demonstration that includes grinding, mixing, and tasting fresh chocolate. You will also sample different coffee varieties and learn what makes Costa Rican coffee among the best in the world.

The tasting includes artisanal chocolate, freshly brewed coffee, and other tropical treats that will delight your taste buds.

A full traditional lunch is included, featuring farm-fresh ingredients and authentic Costa Rican flavors.`,
    price: 235,
    duration: "8 hours",
    rating: 5.0,
    reviewCount: 5,
    image: "https://mmlbslwljvmscbgsqkkq.supabase.co/storage/v1/object/public/Cristian/llanos3.webp",
    images: [
      "https://mmlbslwljvmscbgsqkkq.supabase.co/storage/v1/object/public/Cristian/llanos3.webp",
      "https://mmlbslwljvmscbgsqkkq.supabase.co/storage/v1/object/public/Cristian/llanos4.webp",
      "https://mmlbslwljvmscbgsqkkq.supabase.co/storage/v1/object/public/Cristian/llanos5.webp",
      "https://mmlbslwljvmscbgsqkkq.supabase.co/storage/v1/object/public/Cristian/llanos6.webp",
      "https://mmlbslwljvmscbgsqkkq.supabase.co/storage/v1/object/public/Cristian/morpho.jpg",
      "https://mmlbslwljvmscbgsqkkq.supabase.co/storage/v1/object/public/Cristian/cafe.webp"
    ],
    category: "Combo Experience",
    highlights: [
      "Free cancellation up to 24 hours before",
      "Visit a sloth conservation sanctuary",
      "Scenic waterfall hike through tropical forest",
      "Hands-on chocolate-making experience",
      "Coffee tasting with multiple varieties",
      "Traditional lunch included"
    ],
    included: [
      "Traditional Costa Rican lunch",
    ...
    notIncluded: [
      "Professional photos",
      "Tips",
      "Coffee and chocolate products for purchase"
    ],
    itinerary: [
      "Hotel pickup in air-conditioned vehicle",
      "Transfer to sloth sanctuary",
      "Guided tour of the sanctuary — observe sloths and other wildlife",
      "Learn about sloth conservation efforts",
      "Transfer to waterfall trailhead",
      "Guided hike to the waterfall",
      "Enjoy the waterfall views and natural surroundings",
      "Traditional Costa Rican lunch",
      "Visit to coffee and cacao farm",
      "Hands-on chocolate-making demonstration",
      "Coffee and chocolate tasting session",
      "Return transfer to hotel"
    ],
    ...
    cancellationPolicy: "For a full refund, you must cancel the experience at least 24 hours before it starts.",
    ageRange: "All ages",
    accessibility: "Moderate walking required — some uneven terrain on waterfall trail",
    additionalInfo: [
      "Confirmation will be received at time of booking",
      "Wear comfortable walking shoes",
      "Bring insect repellent and sun protection",
      "Camera recommended for sloth photos",
      "This is a private tour — only your group will participate"
    ],
    isCombo: true
  }
